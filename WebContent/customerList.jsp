...
<script type="text/javascript">
	function deleteThis(user_email) {
		if(confirm("are you sure you want to delete this record")){
			window.location.href="${pageContext.request.contextPath}/Customer/List?deleteId="+user_email;
...
<body>
  ...
  <path fill-rule="evenodd"
						...
						<td>
							<a class="button" onclick="deleteThis('${customer.email}')" ${deleteCustomer_view} > 
