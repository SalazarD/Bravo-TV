...
public class ChannelPackage implements Bean {
	...
	public String toString() {
		return "ChannelPackage [package_id=" + package_id + ", package_name=" + package_name + ", package_category="
				+ package_category + ", package_charging_type=" + package_charging_type + ", package_transmission_type="
				+ package_transmission_type + ", package_cost=" + package_cost + ", package_available_from_date="
				+ package_available_from_date + ", package_available_to_date=" + package_available_to_date
				+ ", added_by_default=" + added_by_default + "]";
	}

	private static final String[] COLUMN_NAMES = new String[] { "package_id", "package_name", "package_category",
			"package_charging_type", "package_transmission_type", "package_cost", "package_available_from_date",
			"package_available_to_date", "added_by_default" };
	...
	public Object[] getColumnValues() {
		return new Object[] { package_id, package_name, package_category, package_charging_type,
				package_transmission_type, package_cost, package_available_from_date, package_available_to_date,
				added_by_default
